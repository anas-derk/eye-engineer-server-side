...
propertyValuationRouter.post("/create-order",
    (req, res, next) => {
        ...
        validateIsExistValueForFieldsAndDataTypes([
            ...
            { fieldName: "Representative Full Name", fieldValue: bodyData?.representativeFullName, dataTypes: ["string"], isRequiredValue: owner === "representative" },
            { fieldName: "Legal Entity", fieldValue: bodyData?.legalEntity, dataTypes: ["string"], isRequiredValue: owner === "representative" },
